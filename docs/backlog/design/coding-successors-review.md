...
| [044](../in_progress/BAZ-044-specialist-verification-handoff.md) | Named operator-reviewed checks and new peer access duplicated or contradicted 040. | Capture task-selected commands and actual environment; restrict specialist execution to that request and bind results to code. Reuse peer access and yield/resume. |
